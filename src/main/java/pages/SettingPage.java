...
public class SettingPage {
    ...
    //To verify whether Manage debtor code page of pet displays with debtor code details by clicking on change debtor code icon on setting page
    ...
    //Add debtor code page of pet displays will all details when user clicks on add debtor code icon on manage sex page
    ...
    //Edit debtor code page of pet displays upon clicking on edit icon against debtor code on manage debtor code page
